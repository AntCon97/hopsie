...
<header class="site-header grid-x align-middle" role="banner" id='header'>

<div class="top-bar">
  <div class="top-bar-left">
    <ul class="dropdown menu" data-dropdown-menu>
      <li class="menu-text title">Hopsie</li>
      <li class='item'><a href="<?php echo site_url('/') ?>">Home</a></li>
      <li class='item'>
        <a href="<?php echo site_url('/sample-page') ?>">Sample Page</a>
      </li>

      <li class='item'><a href="<?php echo site_url('/Privacy-Policy') ?>">Privacy Policy</a></li>
    </ul>
  </div>
